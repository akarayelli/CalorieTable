...
public class SharedPreferencesUtil {
    ...
    private static SharedPreferencesUtil prefsInstance;
    ...
    private SharedPreferencesUtil(@NonNull Context context){
    ...
    private SharedPreferencesUtil(@NonNull Context context, @NonNull String preferencesName){
        sharedPreferences = context.getApplicationContext().getSharedPreferences(
                preferencesName,
                Context.MODE_PRIVATE
        );
     ...
     */
    public static SharedPreferencesUtil with(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new SharedPreferencesUtil(context);
        }
     ...
     * @return Returns a 'Prefs' instance
     */
    public static SharedPreferencesUtil with(@NonNull Context context, boolean forceInstantiation) {
     ...
     * @return Returns a 'Prefs' instance
     */
    public static SharedPreferencesUtil with(@NonNull Context context, @NonNull String preferencesName) {
        if (prefsInstance == null) {
            prefsInstance = new SharedPreferencesUtil(context, preferencesName);
        }
        return prefsInstance;
    }
